...
/// The password field for a [`Job`](crate::domain::job::Job).
...
impl Password {
    ...
    /// some were to be added, then a [`JobError`] should be returned.
    pub fn new<T: Into<Option<String>>>(password: T) -> Result<Self, JobError> {
